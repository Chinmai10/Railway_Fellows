# Generated by Django 3.1.7 on 2024-07-05 17:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.CharField(choices=[('Normal', 'Normal'), ('Express', 'Express')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trains', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trains.trains')),
                ('users', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trains.users')),
            ],
        ),
    ]
